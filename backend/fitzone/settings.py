...
# ===== Email =====
# Defaults to printing emails to the console in dev so the flow works with
# zero setup; set EMAIL_BACKEND (and the SMTP_* vars below) in production to
# actually deliver mail through a real provider.
EMAIL_BACKEND = env(
    "EMAIL_BACKEND",
    default=(
